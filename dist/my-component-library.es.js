...
const A = 2, Dn = 4, _ = 8, $ = 16, D = 32, x = 64, g = 128, V = 256, E = 512, k = 1024, j = 2048, nn = 4096, m = 8192, wn = 16384, Cn = 65536, Sn = 1 << 18, rn = 1 << 19;
function Jn(n) {
  return n === this.v;
}
function Rn(n, r) {
...
function G(n) {
  ln(n), R(n, 0), d(n, m), n.v = n.children = n.deps = n.ctx = n.reactions = null;
}
function qn(n, r) {
  var t = r.last;
...
function F(n, r = !0) {
  ...
  sn(n);
  var o = n.parent;
  o !== null && o.first !== null && fn(n), n.next = n.prev = n.teardown = n.ctx = n.deps = n.parent = n.fn = n.nodes_start = n.nodes_end = null;
}
function fn(n) {
    ...
    if (t !== null) {
      ...
      for (u = 0; u < t.length; u++) {
        ...
        if (O(
          ...
          /** @type {Derived} */
          e
        ), l && f !== null && !b && !((o = e == null ? void 0 : e.reactions) != null && o.includes(n)) && (e.reactions ?? (e.reactions = [])).push(n), e.version > n.version)
          return !0;
      }
    }
    l || d(n, E);
...
function vn(n) {
  ...
  try {
    ...
    if (p !== null) {
      var a;
      if (R(n, I), i !== null && I > 0)
        for (i.length = I + p.length, a = 0; a < p.length; a++)
          i[I + a] = p[a];
      else
        n.deps = i = p;
      if (!b)
        for (a = I; a < i.length; a++)
          ((h = i[a]).reactions ?? (h.reactions = [])).push(n);
...
function Un(n, r) {
  ...
  (p === null || !p.includes(r)) && (d(r, j), r.f & (g | V) || (r.f ^= V), R(
    /** @type {Derived} **/
    r,
    0
  ));
...
function Xn(n) {
  ...
  if (r !== 0)
    for (var t = 0; t < r; t++) {
      var l = n[t];
      !(l.f & (m | nn)) && O(l) && (z(l), l.deps === null && l.first === null && l.nodes_start === null && (l.teardown === null ? fn(l) : l.fn = null));
    }
}
function Hn() {
  if (q = !1, w > 1001)
...
function Kn(n) {
  ...
  if (T !== null) {
    C !== null && C.includes(n) && Pn();
    var u = T.deps;
    p === null && u !== null && u[I] === n ? I++ : p === null ? p = [n] : p.push(n), S !== null && f !== null && f.f & E && !(f.f & D) && S.includes(n) && (d(f, k), yn(f));
...
function lr(n) {
  for (var r = f, t = f; r !== null && !(r.f & (D | x)); )
    r = r.parent;
  try {
    return L(r), n();
  } finally {
...
function Y(n, r, t, l) {
  ...
  var c = (H = An(n, r)) == null ? void 0 : H.set, v = (
    /** @type {V} */
    l
  ), i = !0, a = () => (i && (i = !1, v = /** @type {V} */
  l), v);
  o === void 0 && l !== void 0 && (c && e && mn(), o = a(), c && c(o));
  var h;
  if (e)
    h = () => {
      var N = (
...
function sr(n, r) {
  let t = Y(r, "title", 8, "Welcome!"), l = Y(r, "description", 8, "This is a reusable banner component.");
  var u = er(), e = Q(u);
  rr(e, "src", ur);
