  ...
  <div class="flex flex-col gap-3 px-2 ">
    ...
    <div class="relative w-full min-h-44 rounded-xl overflow-hidden mt-4 flex items-center justify-between text-center md:text-left" style="background-image: url({ prizePool.background || '/api/placeholder/1920x1080'});">
        ...
        <div class="relative z-10 h-full flex flex-col justify-center lg:px-6 lg:justify-center lg:items-start text-center">
            <div class="text-sm font-medium uppercase tracking-wider mb-2 ml-5"
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-2 ">
        {#each prizePool?.prizeDetails.slice(0, 3) || [] as prize, index}
            <div 
                class="rounded-xl p-6 transition-all duration-300 hover:-translate-y-1 text-center md:text-left" 
