...
import CardSlider from './CardSlider.svelte';
  ...
  {#if banner.isLargeBackground && banner.largeBackgroundUrl}
    <div class="main-bg bg-cover" style="background-image: url({banner.largeBackgroundUrl ? banner.largeBackgroundUrl : "https://api.dev.kie.tesseractesports.com/assets/cms_assets/main_banner_bg.png"});">
      <Section>
          ...
          <div class="h-full w-full">
            <div class="bg-image flex max-h-full max-w-full flex-col bg-no-repeat">
              <div class="z-0 flex flex-col justify-end gap-y-4 bg-cover bg-center pb-16 lg:pb-28 pt-[320px] lg:pt-[420px] w-f">
                <img src={banner.logo} alt="" class="z-10 h-[120px] w-24 flex-shrink-0">
    ...
    {:else}
    <div class="main-bg bg-cover" style="background-image: url({banner.backgroundUrl ? banner.backgroundUrl : "https://dev-kie-tmp-docs.s3.ap-south-1.amazonaws.com/tournament-page-assets/BGMI_background.png"});">
      <Section>
        <div class="h-80 w-full py-16 justify-start items-center gap-2.5 inline-flex">
          <div class="grow shrink basis-0 h-48 justify-start items-center gap-2.5 flex">
            <div class="grow shrink basis-0 flex-col justify-start items-start gap-2.5 inline-flex">
              <div class="self-stretch text-white text-6xl font-extrabold leading-10">BMPS 2024</div>
              <div class="self-stretch text-white text-xl font-semibold leading-loose">BATTLEGROUNDS MOBILE PRO SERIES 2024</div>
            </div>
            <div class="w-44 h-48 relative items-center justify-end hidden sm:flex">
              <img src={banner.logo} alt="" class="">
            </div>
          </div>
        </div>
      </Section>
