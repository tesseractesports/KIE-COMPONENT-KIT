...
var file = "node_modules/@splidejs/svelte-splide/components/Splide/Splide.svelte";
...
function create_fragment(ctx) {
  ...
  const block = {
    c: function create2() {
      ...
      add_location(div, file, 92, 0, 2389);
    },
...
var file2 = "node_modules/@splidejs/svelte-splide/components/SplideTrack/SplideTrack.svelte";
function create_fragment2(ctx) {
  ...
  const block = {
    c: function create2() {
      ...
      add_location(ul, file2, 6, 2, 204);
      set_attributes(div, div_data);
      add_location(div, file2, 5, 0, 125);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
...
var SplideTrack = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance2, create_fragment2, safe_not_equal, { class: 0 });
    dispatch_dev("SvelteRegisterComponent", {
      component: this,
      tagName: "SplideTrack",
      options,
...
var file3 = "node_modules/@splidejs/svelte-splide/components/SplideSlide/SplideSlide.svelte";
...
var SplideSlide = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance3, create_fragment3, safe_not_equal, { class: 0 });
    dispatch_dev("SvelteRegisterComponent", {
      component: this,
      tagName: "SplideSlide",
      options,
...
export {
  Splide_default as Splide,
  SplideSlide_default as SplideSlide,
  SplideTrack_default as SplideTrack
};
...
@splidejs/splide/dist/js/splide.esm.js:
   ...
   *)
*/
//# sourceMappingURL=@splidejs_svelte-splide.js.map
