...
// node_modules/kie-tmp-config/enum/common.js
var require_common = __commonJS({
  "node_modules/kie-tmp-config/enum/common.js"(exports, module) {
    ...
    var TournamentTier = Object.freeze({
      1: "1",
      2: "2",
      3: "3"
    });
    var VendorStatusCode = Object.freeze({
      Incomplete: 0,
      Complete: 1,
      UnderProcess: 2,
      Accepted: 3,
    ...
    var VendorApplicationStatus = Object.freeze({
    ...
    var TournamentApplicationStatus = Object.freeze({
    ...
    var TotalTurnover = Object.freeze({
      UnderLoss: "UnderLoss",
...
// node_modules/kie-tmp-config/role-permissions/roles.js
var require_roles = __commonJS({
  "node_modules/kie-tmp-config/role-permissions/roles.js"(exports, module) {
    ...
    var AdminRoles = Object.freeze({
      admin: "admin",
      super_admin: "super_admin",
      admin_manager: "admin_manager",
      admin_creative_manager: "admin_creative_manager"
    });
    var TeamRoles = Object.freeze({
      igl: "igl",
      team_owner: "team_owner",
      team_manager: "team_manager",
      team_player: "team_player",
...
// node_modules/kie-tmp-config/validations/validations.js
var require_validations = __commonJS({
  "node_modules/kie-tmp-config/validations/validations.js"(exports) {
    var Joi = require_joi_browser_min();
    var email = Joi.string().regex(/^[a-zA-Z][a-zA-Z0-9._]*@[a-zA-Z]+\.[a-zA-Z]+$/).required();
    var phoneNumber = Joi.string().regex(/^\d{10}$/);
    var dateString = Joi.string().regex(/^\d{4}-\d{2}-\d{2}$/);
    var filePNGJPG = Joi.string().regex(/\.(png|jpg)$/i);
    var filePDFJPG = Joi.string().regex(/\.(pdf|jpg)$/i);
    var website = Joi.string().regex(/^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/|www\.)?[a-zA-Z0-9-]+(\.[a-zA-Z]{2,})+$/);
...
// node_modules/kie-tmp-config/index.js
var require_kie_tmp_config = __commonJS({
  "node_modules/kie-tmp-config/index.js"(exports, module) {
    var {
      EntityTypes,
      VendorTiers,
      VendorStatusCode,
...
export default require_kie_tmp_config();
//# sourceMappingURL=kie-tmp-config.js.map
